...
public class TravelNoteCommentController {
    ...
    public ResponseEntity findAllTravelNoteComment(@PathVariable int id, @PathVariable int userId){
        List<CommentResponse> all = travelNoteCommentService.findAll(id,userId);
